...
<div class="modal fade" id="modal-edit-{{ $coach->user_id }}" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">

        <form action="{{ route('my-profilecoach.update', $coach->user_id) }}" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control" id="validationDefault02"
                                value="{{ $coach->certifications }}" name="certifications" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control" id="validationDefault05"
                                value="{{ $coach->organization }}" name="organization" required>
                        </div>
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control" id="validationDefault05"
                                value="{{ $coach->first_name }}" name="first_name" required>
                        </div>

                        <div class="col mb-3">
                            <label for="validationDefault05">Last Name</label>
                            <input type="text" class="form-control" id="validationDefault05"
                                value="{{ $coach->last_name }}" name="last_name" required>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control" id="validationDefault05"
                                value="{{ $coach->phone }}" name="phone" required>
                        </div>

                        <div class="col mb-3">
                            <label for="validationDefault03">Email</label>
                            <input type="text" class="form-control" id="validationDefault03"
                                value="{{ $coach->email }}" name="email" required>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control" id="validationDefault05"
                                value="{{ $coach->specialty }}" name="specialty" required>
                        </div>
                ...
                <div class="form-row">
                    <div class="col text-center mt-3">
                        <a href="{{ route('my-profilecoach') }}" class="btn btn-danger col-4 mb-3">Cancel</a>
